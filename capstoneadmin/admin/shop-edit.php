    ...
    <class="card-body">
        ...
        <form action="tattoocode.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="edit_number" value="<?php echo $row['contact']?>" class="form-control">
                </div> 
                <div class="form-group">
                    <label> Available Schedule </label>
                    <input type="text" name="edit_schedule" value="<?php echo $row['schedule']?>" class="form-control">
                </div>
                <div class="form-group">
                    <!-- <label> Followers </label>
                    <input type="text" name="edit_followers" value="<?php echo $row['followers']?>" class="form-control"> -->
                </div> 
                <div class="form-group">
                ...
                <button type="submit" id="shops_update_btn" class="btn btn-primary"> UPDATE </button>
            </form>
