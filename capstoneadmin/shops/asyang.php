...
<h1 class="heading"> About Asyang Tattoo </h1>
...
<h2 style="color:black; font-family: 'Poppins', sans-serif"><img src="ann.png" style="height: 50px; width: 40px">Announcements</h2>
    <div class="row">
        <?php
            ...
            $query = "SELECT * FROM announcements WHERE shopname='Asyang Tattoo'";
            $query_run = mysqli_query($con,$query);
...
<div class="box-container">
        <?php
            ...
            $query = "SELECT shopname, image FROM works WHERE shopname='Asyang Tattoo'";
            $query_run = mysqli_query($con,$query);
...
<div class="container-fluid px-4">
    <h2 class="mt-4" style="margin-left: 33%; color:blackblack ">Tattoo Prices</h2>
    <div class="row">
        <div class="card-body">
        </div>
