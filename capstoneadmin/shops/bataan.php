...
<h1 class="heading"> About Bataan Tattoo </h1>
...
<h2 style="color:black; font-family: 'Poppins', sans-serif"><img src="ann.png" style="height: 50px; width: 40px">Announcements</h2>
    <div class="row">
        <?php
            ...
            $query = "SELECT * FROM announcements WHERE shopname='Bataan Tattoo'";
            $query_run = mysqli_query($con,$query);
...
<div class="box-container">
        <?php
            ...
            $query = "SELECT shopname, image FROM works WHERE shopname='Bataan Tattoo'";
            $query_run = mysqli_query($con,$query);
