...
<h1 class="heading"> About Herchel Vape and Ink </h1>
...
<div class="card" style="width:600px; height:350px">
    <div class="card-body">
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: blackblack">Email: </strong><?php echo $row['email'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: blackblack">Contact Number: </strong><?php echo $row['contact']; ?> </h5>
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: blackblack">Available Schedule: </strong><?php echo $row['schedule'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: blackblack">Followers: </strong><?php echo $row['followers']; ?> </h5>
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: blackblack">Description: </strong><?php echo $row['description'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: blackblack">Location: </strong><?php echo $row['location']; ?> </h5>
...
<br />
<div class="location">
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3863.558041114081!2d120.58104395020156!3d14.452615184511622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x339623afa57cea4d%3A0x9ea5fa46d38849af!2sHerchel%20Vape%20House!5e0!3m2!1sen!2sph!4v1655524165874!5m2!1sen!2sph" 
...
<h2 style="color:black; font-family: 'Poppins', sans-serif"><img src="ann.png" style="height: 50px; width: 40px">Announcements</h2>
    <div class="row">
        <?php
            ...
            $query = "SELECT * FROM announcements WHERE shopname='Herchel Vape And Ink'";
            $query_run = mysqli_query($con,$query);
        ...
        <div class="head">
            ...
            <div class="card" style="width:220px; height:180px; background-color: white">
    ...
    <div class="book">
        <div class="card" style="background-color: #FFF6EA; border: 2px solid #534340">
            <div class="card-body">
                ...
                <a href="../appointment/herchel/index.php"><h4 style="color:red; margin-right:12%">Click here to book an appointment</h4></a>
            </div>
        </div>
    </div>
</div>
