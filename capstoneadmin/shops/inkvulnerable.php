...
<div class="user">
    ...
    <a href="../tattooshop.php" class="previous" style="float:rights">&laquo; Back to Shops</a>
   <?php
...
<h1 class="heading"> About Inkvulnerable Tattoo </h1>
...
<h2 style="color:black; font-family: 'Poppins', sans-serif"><img src="ann.png" style="height: 50px; width: 40px">Announcements</h2>
    <div class="row">
        <?php
            ...
            $query = "SELECT * FROM announcements WHERE shopname='Inkvulnerable Tattoo'";
            $query_run = mysqli_query($con,$query);
