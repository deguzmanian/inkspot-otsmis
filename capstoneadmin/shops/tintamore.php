...
<h1 class="heading"> About Tintamore </h1>
...
<div class="card" style="width:600px; height:350px">
    <div class="card-body">
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: ">Email: </strong><?php echo $row['email'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: ">Contact Number: </strong><?php echo $row['contact']; ?> </h5>
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: ">Available Schedule: </strong><?php echo $row['schedule'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: ">Followers: </strong><?php echo $row['followers']; ?> </h5>
        <h5 class="card-title" style="color: black; font-size:20px"><strong style="color: ">Description: </strong><?php echo $row['description'];?> </h5>
        <h5 class="card-title" style="color: black;font-size: 20px"><strong style="color: ">Location: </strong><?php echo $row['location']; ?> </h5>
...
<h2 style="color:black; font-family: 'Poppins', sans-serif"><img src="ann.png" style="height: 50px; width: 40px">Announcements</h2>
    <div class="row">
        <?php
            ...
            $query = "SELECT * FROM announcements WHERE shopname='Tintamore'";
            $query_run = mysqli_query($con,$query);
    ...
    <div class="book">
        <div class="card" style="background-color: #FFF6EA; border: 2px solid #534340">
            <div class="card-body">
                ...
                <a href="#"><h4 style="color:red; margin-right:12%">Click here to book an appointment</h4></a>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid px-4">
    <h2 class="mt-4" style="margin-left: 33%; color: ">Tattoo Prices</h2>
    <div class="row">
        <div class="card-body">
        </div>
    ...
    <div class="col-md-12" style="height: 200%; width: 200%">
        ...
        <div class="card" style="color:; padding-right: 25px; padding-left: 4%">

            <div class="card-body" style="padding-right: 25px">

            <table class="table table-bordered" style="border: 3px solid ; font-size: 15px; width: 30%">
                <thread>
                    <tr>
                        <th style="border: 2px solid ">Color</th>
                        <th style="border: 2px solid ">Size</th>
                        <th style="border: 2px solid ">Artist Fee</th>
                        <th style="border: 2px solid ">Estimated Total</th>
                    </tr>
                </thread>
                <tbody>
                    <?php
...
<br />
<div class="container-fluid px-4">
    <h2 class="mt-4" style="margin-left: 33%; color: ">Services Prices</h2>
    <div class="row">
        <div class="card-body">
        </div>
    ...
    <div class="col-md-12" style="height: 200%; width: 200%">
        ...
        <div class="card" style="color:; padding-right: 25px; padding-left: 4%">
            ...
            <table class="table table-bordered" style="border: 3px solid ; font-size: 15px; width: 30%">
                <thread>
                    <tr>
                        <th style="border: 2px solid ">Type of Services</th>
                        <th style="border: 2px solid ">Estimated Amount</th>
                    </tr>
                </thread>
                <tbody>
                    <?php
